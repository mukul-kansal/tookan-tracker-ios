...
SWIFT_MODULE_NAMESPACE_PUSH("TookanTracker")
...
@interface CocoaMQTT (SWIFT_EXTENSION(TookanTracker)) <GCDAsyncSocketDelegate>
...
/// MQTT Delegate
SWIFT_PROTOCOL("_TtP13TookanTracker17CocoaMQTTDelegate_")
...
SWIFT_CLASS("_TtC13TookanTracker20CocoaMQTTFrameBuffer")
@interface CocoaMQTTFrameBuffer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13TookanTracker15CocoaMQTTLogger")
...
/// QOS
typedef SWIFT_ENUM(uint8_t, CocoaMQTTQOS) {
  CocoaMQTTQOSQos0 = 0,
  CocoaMQTTQOSQos1 = 1,
  CocoaMQTTQOSQos2 = 2,
};
...
@interface MqttClass (SWIFT_EXTENSION(TookanTracker)) <CocoaMQTTDelegate>
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didConnectAck:(enum CocoaMQTTConnAck)ack;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didPublishMessage:(CocoaMQTTMessage * _Nonnull)message id:(uint16_t)id;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didPublishAck:(uint16_t)id;
- (void)mqtt:(CocoaMQTT * _Nonnull)mqtt didReceiveMessage:(CocoaMQTTMessage * _Nonnull)message id:(uint16_t)id;
