...
SWIFT_MODULE_NAMESPACE_PUSH("TookanTracker_SDK")
@class GCDAsyncSocket;

/// Main CocoaMQTT Class
/// Notice: GCDAsyncSocket need delegate to extend NSObject
SWIFT_CLASS("_TtC17TookanTracker_SDK9CocoaMQTT")
...
/// MQTT Message
SWIFT_CLASS("_TtC17TookanTracker_SDK16CocoaMQTTMessage")
...
/// MQTT Will Message
SWIFT_CLASS("_TtC17TookanTracker_SDK13CocoaMQTTWill")
@interface CocoaMQTTWill : CocoaMQTTMessage
@end

@class CLLocation;

SWIFT_PROTOCOL("_TtP17TookanTracker_SDK23LocationTrackerDelegate_")
...
SWIFT_CLASS("_TtC17TookanTracker_SDK19LocationTrackerFile")
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (LocationTrackerFile * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
+ (CLLocationManager * _Nonnull)sharedLocationManager SWIFT_WARN_UNUSED_RESULT;
- (CLLocation * _Null_unspecified)getCurrentLocation SWIFT_WARN_UNUSED_RESULT;
- (void)initMqtt SWIFT_METHOD_FAMILY(none);
- (void)setLocationUpdate;
- (void)subsribeMQTTForTracking;
- (void)stopLocationService;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
@end


SWIFT_CLASS("_TtC17TookanTracker_SDK9MqttClass")
...
SWIFT_CLASS("_TtC17TookanTracker_SDK13TookanTracker")
