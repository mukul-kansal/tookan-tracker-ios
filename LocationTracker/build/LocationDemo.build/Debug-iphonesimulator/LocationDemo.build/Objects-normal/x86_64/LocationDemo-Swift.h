...
SWIFT_PROTOCOL("_TtP12LocationDemo23LocationTrackerDelegate_")
@protocol LocationTrackerDelegate
@optional
...
@interface NSLocale (SWIFT_EXTENSION(LocationDemo))
@end


@interface UIButton (SWIFT_EXTENSION(LocationDemo))
@end


@interface UILabel (SWIFT_EXTENSION(LocationDemo))
@end


@interface UIView (SWIFT_EXTENSION(LocationDemo))
@end
